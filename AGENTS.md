...
AGENTS MUST ONLY USE GIT TO EXAMINE THE REPOSITORY, NOT TO MUTATE REPOSITORY STATE. No commits, no branches, no stashes, no resets—only read-only operations (status, diff, log, show, blame).
