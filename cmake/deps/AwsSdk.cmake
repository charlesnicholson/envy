...
set(CODEX_AWSCRT_ROOT "${aws_sdk_SOURCE_DIR}/crt/aws-crt-cpp")
set(_aws_crt_marker "${CODEX_AWSCRT_ROOT}/crt/aws-c-common/CMakeLists.txt")
if(NOT EXISTS "${CODEX_AWSCRT_ROOT}/CMakeLists.txt" OR NOT EXISTS "${_aws_crt_marker}")
    message(STATUS "[codex] Prefetching AWS CRT dependencies...")
    execute_process(
        COMMAND ${CMAKE_COMMAND}
            -Daws_sdk_SOURCE_DIR=${aws_sdk_SOURCE_DIR}
            -Dcodex_project_source_dir=${PROJECT_SOURCE_DIR}
