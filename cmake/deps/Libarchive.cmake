...
# Disable sanitizers for libarchive due to thread-safety issues with global state
# (default_inode in archive_read_support_format_tar.c)
foreach(_envy_archive_target IN ITEMS archive archive_static libarchive)
    if(TARGET ${_envy_archive_target})
        set_property(TARGET ${_envy_archive_target} PROPERTY INTERPROCEDURAL_OPTIMIZATION OFF)
        if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
            target_compile_options(${_envy_archive_target} PRIVATE -fno-sanitize=all)
        endif()
    endif()
endforeach()
unset(_envy_archive_target)
