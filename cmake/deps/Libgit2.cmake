...
cmake_path(CONVERT "${ENVY_CA_BUNDLE}" TO_CMAKE_PATH_LIST _envy_ca_bundle_norm)
if(NOT CERT_LOCATION OR CERT_LOCATION MATCHES "/certs/cacert\\.pem$")
    set(CERT_LOCATION "${_envy_ca_bundle_norm}" CACHE STRING "" FORCE)
else()
    set(CERT_LOCATION "${CERT_LOCATION}" CACHE STRING "" FORCE)
endif()
unset(_envy_ca_bundle_norm)
set(CMAKE_DISABLE_FIND_PACKAGE_PkgConfig ON)
cmake_path(APPEND ENVY_THIRDPARTY_CACHE_DIR "${ENVY_LIBGIT2_ARCHIVE}" OUTPUT_VARIABLE _libgit2_archive)
...
cmake_path(APPEND ENVY_THIRDPARTY_CACHE_DIR "libgit2-src" OUTPUT_VARIABLE libgit2_SOURCE_DIR)
