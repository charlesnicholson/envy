...
set(_envy_libssh2_archive_name "${_envy_libssh2_output_name}")
if(NOT "${CMAKE_STATIC_LIBRARY_PREFIX}" STREQUAL "")
    string(LENGTH "${CMAKE_STATIC_LIBRARY_PREFIX}" _envy_libssh2_prefix_len)
    string(SUBSTRING "${_envy_libssh2_archive_name}" 0 ${_envy_libssh2_prefix_len} _envy_libssh2_prefix)
    if(NOT "${_envy_libssh2_prefix}" STREQUAL "${CMAKE_STATIC_LIBRARY_PREFIX}")
        set(_envy_libssh2_archive_name "${CMAKE_STATIC_LIBRARY_PREFIX}${_envy_libssh2_archive_name}")
    endif()
endif()
if(NOT "${CMAKE_STATIC_LIBRARY_SUFFIX}" STREQUAL "")
    string(LENGTH "${_envy_libssh2_archive_name}" _envy_libssh2_name_len)
    string(LENGTH "${CMAKE_STATIC_LIBRARY_SUFFIX}" _envy_libssh2_suffix_len)
    if(_envy_libssh2_name_len GREATER_EQUAL _envy_libssh2_suffix_len)
        math(EXPR _envy_libssh2_suffix_start "${_envy_libssh2_name_len} - ${_envy_libssh2_suffix_len}")
        string(SUBSTRING "${_envy_libssh2_archive_name}" ${_envy_libssh2_suffix_start} ${_envy_libssh2_suffix_len} _envy_libssh2_suffix)
    else()
        set(_envy_libssh2_suffix "")
    endif()
    if(NOT "${_envy_libssh2_suffix}" STREQUAL "${CMAKE_STATIC_LIBRARY_SUFFIX}")
        set(_envy_libssh2_archive_name "${_envy_libssh2_archive_name}${CMAKE_STATIC_LIBRARY_SUFFIX}")
    endif()
endif()

cmake_path(APPEND libssh2_BINARY_DIR "src" "${_envy_libssh2_archive_name}" OUTPUT_VARIABLE _envy_libssh2_expected_archive)
...
unset(_envy_libssh2_archive_name)
unset(_envy_libssh2_prefix_len)
unset(_envy_libssh2_prefix)
unset(_envy_libssh2_suffix_len)
unset(_envy_libssh2_name_len)
unset(_envy_libssh2_suffix_start)
unset(_envy_libssh2_suffix)
