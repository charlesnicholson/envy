...
if(MSVC)
    cmake_path(APPEND CMAKE_BINARY_DIR "_deps" "envy_libzstd-build" OUTPUT_VARIABLE _libzstd_masm_stamp_dir)
    set(_libzstd_masm_stamp "${_libzstd_masm_stamp_dir}/envy_libzstd_masm_patch.stamp")
    if(NOT EXISTS "${_libzstd_masm_stamp}")
        ...
        file(WRITE "${_libzstd_masm_stamp}" "patched\n")
    endif()
    unset(_libzstd_masm_stamp)
endif()
