...
struct temp_dir {
  ...
  temp_dir() : path(fs::temp_directory_path() / "envy_test_ctx_move") {
    fs::remove_all(path);
...
TEST_CASE("ctx.move - file to file") {
...
TEST_CASE("ctx.move - file to existing directory") {
  lua_ctx_move_fixture fixture;
  fixture.create_file("src.txt", "test content");
...
TEST_CASE("ctx.move - file to new directory path") {
  lua_ctx_move_fixture fixture;
  fixture.create_file("src.txt", "test content");
...
TEST_CASE("ctx.move - directory to directory") {
  lua_ctx_move_fixture fixture;
...
TEST_CASE("ctx.move - destination exists (error)") {
  lua_ctx_move_fixture fixture;
...
TEST_CASE("ctx.move - absolute paths") {
  lua_ctx_move_fixture fixture;
