...
TEST_CASE("reexec_download_url: custom mirror") {
  auto const url{
    envy::reexec_download_url("https://my-mirror.example.com/envy",
                                    "2.0.0", "linux", "x86_64")
  };
...
TEST_CASE("reexec_download_url: file mirror") {
  auto const url{
    envy::reexec_download_url("file:///tmp/releases",
                                    "1.0.0", "darwin", "arm64")
  };
...
TEST_CASE("reexec_download_url: s3 mirror") {
  auto const url{
    envy::reexec_download_url("s3://my-bucket/envy-releases",
                                    "3.1.0", "linux", "arm64")
  };
...
TEST_CASE("reexec_download_url: trailing slash on mirror produces double slash") {
  ...
  auto const url{
    envy::reexec_download_url("https://mirror.example.com/",
                                    "1.0.0", "darwin", "arm64")
  };
