...
DEPENDENCIES = {
  { spec = "local.dep_val_lib@v1", source = "dep_val_lib.lua", needed_by = "stage" },
  { product = "tool", spec = "local.product_provider@v1", source = "product_provider.lua", needed_by = "stage" },
}
